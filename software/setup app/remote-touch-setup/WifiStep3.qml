...
Item {
    ...
    Text {
        color: colorText
        opacity: 0.4
        text: "Please enter your network SSID and password"
        horizontalAlignment: Text.AlignHCenter
    ...
    TextField {
        ...
        width: parent.width-40
        anchors.top: textfieldWifiSSID.bottom
    ...
    CustomButton {
        ...
        Timer {
            ...
            onTriggered: {
                myLauncher.launch("/usr/bin/wifi_network_create.sh " + textfieldWifiSSID.text + " " + textfieldWifiPassword.text);
