...
Item {
    ...
    Text {
        id: header
        color: colorText
        text: translations[language].settings.network
    ...
    Rectangle {
        ...
        Text {
            id: wifiSignalText
            color: colorText
            text: translations[language].settings.wifisignal
            anchors.left: parent.left
        ...
        Text {
            id: ipaddressText
            color: colorText
            text: translations[language].settings.ipaddress
            anchors.left: parent.left
            anchors.leftMargin: 20
        ...
        Text {
            id: macaddressText
            color: colorText
            text: translations[language].settings.macaddress
            anchors.left: parent.left
            anchors.leftMargin: 20
