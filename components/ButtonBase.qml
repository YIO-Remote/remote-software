...
Rectangle {
    ...
    Rectangle {
        ...
        Rectangle {
            ...
            Text {
                color: Style.color.text
                text: obj
                      && obj.favorite ? Style.icon.fav_remove : Style.icon.fav_add
        ...
        Text {
            ...
            opacity: 0
            text: obj
                  && obj.favorite ? qsTr("Remove from favorites")
                                    + translateHandler.emptyString : qsTr(
                                        "Add to favorites") + translateHandler.emptyString
            wrapMode: Text.WordWrap
            anchors {
                left: addToFavButtonCircle.right
                leftMargin: 26
                verticalCenter: addToFavButtonCircle.verticalCenter
            }
            font: Style.font.button
        }
    }
    ...
    Connections {
        ...
        onButtonPressed: {
            if (StandbyControl.mode === StandbyControl.ON
                    || StandbyControl.mode === StandbyControl.DIM) {
