...
class YioAPI : public YioAPIInterface {
 ...
 private:
    ...
    QByteArray m_hash =
        ...
        "1\xFA\x90\xED\x16\xBB";  // QCryptographicHash::hash(m_token.toLocal8Bit(), QCryptographicHash::Sha512);
    QString m_hostname;
    ...
    QMap<QString, QVariantMap>
        m_discoveredServices;  // name as string, <ip address as string, mdns name as string>  "192.169.100.1", 496
};
