...
class Entity : public QObject, EntityInterface {
 ...
 public:
    ...
    explicit Entity(const QString& type, const QVariantMap& config, IntegrationInterface* integrationObj,
 ...
 protected:
    void initializeSupportedFeatures(
        const QVariantMap& config);  // !!!! must be called in every concrete entity constructor !!!!
