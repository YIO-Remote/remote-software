...
public:
    ...
    enum Features       {
        ...
        // input
        F_SOURCE, F_INPUT_TUNER_1, F_INPUT_TUNER_2, F_INPUT_TUNER_X, F_INPUT_HDMI_1, F_INPUT_HDMI_2, F_INPUT_HDMI_X, F_INPUT_X_1, F_INPUT_X_2,

        // output
        F_OUTPUT_HDMI_1, F_OUTPUT_HDMI_2, F_OUTPUT_DVI_1, F_OUTPUT_AUDIO_X, F_OUTPUT_X,

        // services
        F_SERVICE_NETFLIX, F_SERVICE_HULUF_
    };
    Q_ENUM (Features)
    ...
    enum Commands {
        ...
        // input
        C_SOURCE, C_INPUT_TUNER_1, C_INPUT_TUNER_2, C_INPUT_TUNER_X, C_INPUT_HDMI_1, C_INPUT_HDMI_2, C_INPUT_HDMI_X, C_INPUT_X_1, C_INPUT_X_2,

        // output
        C_OUTPUT_HDMI_1, C_OUTPUT_HDMI_2, C_OUTPUT_DVI_1, C_OUTPUT_AUDIO_X, C_OUTPUT_X,

        // services
        C_SERVICE_NETFLIX, C_SERVICE_HULUC_
    };
    Q_ENUM (Commands)
