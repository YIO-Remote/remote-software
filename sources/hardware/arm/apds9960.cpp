...
float APDS9960::getADCIntegrationTime() {
    ...
    temp = static_cast<float>(wiringPiI2CReadReg8(_fd, APDS9960_ATIME));
...
apds9960AGain_t APDS9960::getADCGain() { return apds9960AGain_t((wiringPiI2CReadReg8(_fd, APDS9960_CONTROL) & 0x03)); }
...
apds9960PGain_t APDS9960::getProxGain() { return apds9960PGain_t((wiringPiI2CReadReg8(_fd, APDS9960_CONTROL) & 0x0C)); }
...
void APDS9960::setGestureProximityThreshold(uint8_t thresh) { wiringPiI2CWriteReg8(_fd, APDS9960_GPENTH, thresh); }
...
uint16_t APDS9960::getAmbientLight() {
    ...
    uint16_t val = uint16_t(wiringPiI2CReadReg8(_fd, APDS9960_CDATAL));
